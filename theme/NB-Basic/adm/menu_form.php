...
<section class="f-sm font-weight-normal">
	<div class="row">
		<div class="col-sm-6">
			<ul class="list-group">
				<li class="list-group-item bg-primary text-white">작성 후 반드시 하단의 "<b>Save</b>"을 누르셔야 저장됩니다.</li>
		...
		<div class="col-sm-6">
			<form id="frmEdit">
				<ul class="list-group">
					<li class="list-group-item bg-primary text-white">메뉴 수정 후 반드시 "<b>Update</b>"을 누르셔야 반영됩니다.</li>
