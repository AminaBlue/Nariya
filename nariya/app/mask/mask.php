...
echo <<<HTMLCODE
<div class="na-mask-a na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-a$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask-svg" viewBox="0 0 2700 64" width="2700px" height="64px" version="1.1">
		<defs>
...
echo <<<HTMLCODE
<div class="na-mask-b na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-b$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask-svg" viewBox="0 0 2700 57" width="2700px" height="57px" version="1.1">
		<defs>
			<filter id="$id" x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox">
...
echo <<<HTMLCODE
<div class="na-mask-c na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-c$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask mask-fill" viewBox="0 0 767 60" preserveAspectRatio="none meet" width="767px" height="60px" version="1.1">
		<polygon fill="$color" points="767,0 767,50 0,60" />
	</svg>
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask na-mask-over" viewBox="0 0 767 50" preserveAspectRatio="none meet" width="767px" height="50px" version="1.1">
...
echo <<<HTMLCODE
<div class="na-mask-d1 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-d1$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask-svg" viewBox="0 0 5000 27" width="5000px" height="27px" version="1.1">
		<defs>
			<filter id="$id" x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox">
...
echo <<<HTMLCODE
<div class="na-mask-d2 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-d2$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask-svg" viewBox="0 0 5000 57" width="5000px" height="57px" version="1.1">
		<defs>
			<filter id="$id" x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox">
...
echo <<<HTMLCODE
<div class="na-mask-e1 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-e1$rev"><div class="na-mask-fill" style="background-color: $fill;"></div></div>
HTMLCODE;

	} else if($mask == "e2") {

echo <<<HTMLCODE
<div class="na-mask-e2 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-e2$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2560 40" width="2560px" height="40px" version="1.1">
		<polygon fill="$fill" points="0,40 2560,40 2560,0" /> 
	</svg>
</div>
HTMLCODE;
...
echo <<<HTMLCODE
<div class="na-mask-e3 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-e3$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2560 80" width="2560px" height="80px" version="1.1">
		<polygon fill="$fill" points="0,80 2560,80 2560,0" />
	</svg>
</div>
HTMLCODE;
...
echo <<<HTMLCODE
<div class="na-mask-e4 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-e4$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4 0.266661" preserveAspectRatio="none meet" width="100%" height="100px" version="1.1">
		<polygon fill="$fill" points="4,0 4,0.266661 0,0.266661" />
	</svg>
</div>
HTMLCODE;
...
echo <<<HTMLCODE
<div class="na-mask-f na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-f$rev"><div class="na-mask-fill" style="background-color: $fill;"></div></div>
HTMLCODE;

	} else if($mask == "g1") {

echo <<<HTMLCODE
<div class="na-mask-g1 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-g1$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2560 30" width="2560px" height="30px" version="1.1">
		<defs>
...
echo <<<HTMLCODE
<div class="na-mask-g2 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-g2$rev">
...
echo <<<HTMLCODE
<div class="na-mask-h na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-h$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask-svg" viewBox="0 0 2560 80" width="2560px" height="80px" version="1.1">
...
echo <<<HTMLCODE
<div class="na-mask-i1 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-i1$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2560 16" width="2560px" height="16px" version="1.1"> 
		<defs> 
...
echo <<<HTMLCODE
<div class="na-mask-i2 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-i2$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2560 16" width="2560px" height="16px" version="1.1">
		<defs>
...
echo <<<HTMLCODE
<div class="na-mask-j na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-j$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="na-mask-svg" viewBox="0 0 2560 40" width="2560px" height="40px" version="1.1">
		<defs> 
...
echo <<<HTMLCODE
<div class="na-mask-k1 na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-k1$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 50" preserveAspectRatio="none" width="100%" height="50px">
...
echo <<<HTMLCODE
<div class="na-mask-k na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-k$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 170" preserveAspectRatio="none meet" width="30%" height="170px">
		<path fill="$fill" d="M 0 100 L 100 100 L 0 10 Z" />
	</svg>
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 170" preserveAspectRatio="none meet" width="70%" height="170px">
...
echo <<<HTMLCODE
<div class="na-mask-l na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-l$rev">
<svg id="clouds" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100px" viewBox="0 0 100 100" preserveAspectRatio="none">
...
echo <<<HTMLCODE
<div class="na-mask-m na-mask-zone na-mask-height"></div>
<div class="na-mask na-mask-m$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2011 124.95" width="100%" height="120px" preserveAspectRatio="none">
