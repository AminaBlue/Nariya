...
function na_ajax_paging($id, $write_pages, $cur_page, $total_page, $url, $add='') {
	...
	if($first) {
		if ($cur_page < 2) {
			...
			$str .= '<li class="page-item"><a class="page-link" href="javascript:;" onclick="na_page(\''.$id.'\', \''.$url.'1'.$add.'\', \'1\');">'.$first.'</a></li>';
		}
	}
	...
	if ($start_page > 1) { 
		$str .= '<li class="page-item"><a class="page-link" href="javascript:;" onclick="na_page(\''.$id.'\', \''.$url.($start_page-1).$add.'\', \'1\'); return false;">'.$prev.'</a></li>';
	} else {
		$str .= '<li class="page-item disabled"><a class="page-link">'.$prev.'</a></li>'; 
	}
	...
	if ($total_page > 0){
		for ($k=$start_page;$k<=$end_page;$k++){
			if ($cur_page != $k) {
				$str .= '<li class="page-item"><a class="page-link" href="javascript:;" onclick="na_page(\''.$id.'\', \''.$url.$k.$add.'\', \'1\'); return false;">'.$k.'</a></li>';
			} else {
	...
	if ($total_page > $end_page) {
		$str .= '<li class="page-item"><a class="page-link" href="javascript:;" onclick="na_page(\''.$id.'\', \''.$url.($end_page+1).$add.'\', \'1\'); return false;">'.$next.'</a></li>';
	} else {
		$str .= '<li class="page-item disabled"><a class="page-link">'.$next.'</a></li>';
	}
	...
	if($last) {
		if ($cur_page < $total_page) {
			$str .= '<li class="page-item"><a class="page-link" href="javascript:;" onclick="na_page(\''.$id.'\', \''.$url.($total_page).$add.'\', \'1\'); return false;">'.$last.'</a></li>';
		} else {
			$str .= '<li class="page-item disabled"><a class="page-link">'.$last.'</a></li>';
		}
	}
...
function na_emoticon($str){
	...
	if(is_file(NA_PATH.'/skin/emo/'.$emo)) {
